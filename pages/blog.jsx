        ...
        <>
            ...
            <main className="my-10 mx-auto max-w-7xl px-4 sm:my-12 sm:px-6 md:my-16 lg:my-20 lg:px-8 xl:my-28">
                ...
                <section className="grid grid-cols-3 gap-10 mt-4 mb-8">
                    ...
                    <article className="shadow-lg rounded-lg overflow-hidden">
                        <div className="w-full h-40 bg-cover bg-center" style={{ backgroundImage: `url(/beach.jpg)` }}></div>
                        <div className="p-6">
                            <div className="mb-14">
                                <p className="font-bold mb-2 text-indigo-700">Pláž</p>
                                <h2 className="text-lg font-bold mb-2 text-gray-800">Nejlepší pláže na světě</h2>
                                <p className="text-gray-500 tracking-tight">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi optio soluta, quis explicabo corrupti voluptates sunt eum animi doloremque aspernatur itaque inventore! Quis similique architecto itaque molestias unde hic corrupti.</p>
                            </div>
                            <div className="flex items-center">
                                <Image src="/avatar.jpg" height="40" width="40" className="rounded-full" alt="Fotografie autora příspěvku" />
                    ...
                    <article className="shadow-lg rounded-lg overflow-hidden">
                        <div className="w-full h-40 bg-cover bg-center" style={{ backgroundImage: `url(/evening.jpg)` }}></div>
                        <div className="p-6">
                            <div className="mb-14">
                                <p className="font-bold mb-2 text-indigo-700">Večer</p>
                                <h2 className="text-lg font-bold mb-2 text-gray-800">Proč jsou večery úžasné</h2>
                                <p className="text-gray-500 tracking-tight">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi optio soluta, quis explicabo corrupti voluptates sunt eum animi doloremque aspernatur itaque inventore! Quis similique architecto itaque molestias unde hic corrupti.</p>
                            </div>
                            <div className="flex items-center">
                                <Image src="/avatar.jpg" height="40" width="40" className="rounded-full" alt="Fotografie autora příspěvku" />
                    ...
                    <article className="shadow-lg rounded-lg overflow-hidden">
                        <div className="w-full h-40 bg-cover bg-center" style={{ backgroundImage: `url(/car-repair.jpg)` }}></div>
                        <div className="p-6">
                            <div className="mb-14">
                                <p className="font-bold mb-2 text-indigo-700">Oprava aut</p>
                                <h2 className="text-lg font-bold mb-2 text-gray-800">Základní opravy na autě</h2>
                                <p className="text-gray-500 tracking-tight">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi optio soluta, quis explicabo corrupti voluptates sunt eum animi doloremque aspernatur itaque inventore! Quis similique architecto itaque molestias unde hic corrupti.</p>
                            </div>
                            <div className="flex items-center">
                                <Image src="/avatar.jpg" height="40" width="40" className="rounded-full" alt="Fotografie autora příspěvku" />
                ...
                <ReactPaginate
                    ...
                    previousClassName={"bg-gray-500 rounded-full w-10 h-10 shadow-md mr-3"}
